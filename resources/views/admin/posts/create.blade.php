...
<div class="col-md-8 col-md-offset-2">
	<form action="{{ route('post.store') }}" id="postForm" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
		{{csrf_field()}}
		<div class="form-group">
			<label for="">Title</label>
			<input type="text" onkeyup="generateSlug();" id="title" class="form-control" name="title" value="{{old('title')}}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea name="content" id="" cols="110" rows="10"></textarea>
		</div>
		<div class="form-group">
	...
	$(document).ready(function(){
		$('#postForm').validate({
			...
			messages:{
				...
				featured:{
					required: "Choose file featured of post, please!"
				},
				content:{
